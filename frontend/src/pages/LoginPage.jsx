...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-bold text-stone-900" style={{ fontFamily: 'Manrope,sans-serif' }}>{settings.platform_name || 'WellTrack'}</p>
          ...
          {/* Heading */}
          <h1 className="text-4xl font-bold text-stone-900 mb-3" style={{ fontFamily: 'Manrope,sans-serif' }}>
            Welcome back
          </h1>
          ...
          {/* Error */}
          {accessError && (
            <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4 mb-5" data-testid="login-access-error">
              <AlertCircle size={16} className="text-red-600 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-semibold text-red-700">Sign In Error</p>
          ...
          {mode === 'email' ? (
            <div>
              <button onClick={() => { setMode('choose'); setAccessError(''); }} className="flex items-center gap-2 text-sm text-stone-500 hover:text-stone-900 mb-6 transition-colors">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-stone-900/20 bg-white"
                    />
                  </div>
                </div>
                <div>
                  <label className="text-xs font-semibold text-stone-500 uppercase tracking-wider block mb-1.5">Password</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-3 border border-stone-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-stone-900/20 bg-white"
                    />
                    <button type="button" onClick={() => setShowPassword(p => !p)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-600">
            ...
            <div className="space-y-3">
              ...
              {googleAuthEnabled && (
                <button onClick={handleGoogleLogin} data-testid="google-login-btn"
                  className="w-full flex items-center justify-center gap-3 bg-white border border-stone-200 rounded-xl px-6 py-3.5 text-sm font-semibold text-stone-700 hover:bg-stone-50 hover:border-stone-300 shadow-sm transition-all duration-150 active:scale-[0.98]">
      ...
      {/* Right panel */}
      <div className="hidden lg:flex flex-1 flex-col justify-between p-12" style={{ backgroundColor: '#1c3a2e' }}>
        <div />
        <div>
          <div className="grid grid-cols-3 gap-3 mb-8">
            {[
              { label: 'Tier 1', count: '100%', color: 'bg-teal-400', desc: 'Universal' },
              { label: 'Tier 2', count: '20%',  color: 'bg-amber-400',  desc: 'Targeted' },
              { label: 'Tier 3', count: '5%',   color: 'bg-red-400',   desc: 'Intensive' },
            ].map(item => (
