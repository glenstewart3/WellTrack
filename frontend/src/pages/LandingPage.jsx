    ...
    <div className="min-h-screen bg-stone-950 text-white overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 lg:px-16 py-5">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-5 py-2.5 text-sm font-semibold bg-white text-stone-900 rounded-full hover:bg-teal-400 hover:text-stone-900 transition-all"
          >
            School Login
          </button>
        </div>
      ...
      <section className="relative px-6 lg:px-16 pt-16 pb-24 lg:pt-24 lg:pb-32">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-teal-500/8 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-1/4 w-80 h-80 bg-blue-500/6 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/5 border border-white/10 rounded-full text-xs font-medium text-teal-400 mb-6">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              className="group px-8 py-4 bg-teal-500 text-stone-900 rounded-2xl text-sm font-bold hover:bg-teal-400 transition-all flex items-center gap-2.5 shadow-lg shadow-teal-500/20"
            >
              <Search size={16} />
              Find Your School
      ...
      {/* Features */}
      <section className="px-6 lg:px-16 py-20 bg-stone-900/50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: ClipboardCheck, title: 'Universal Screening', desc: 'SAEBRS and SAEBRS+ self-report screening with automated risk classification across social, academic, and emotional domains.', color: 'text-teal-400 bg-teal-500/10' },
            ...
            {[
              ...
              <div key={step} className="text-center">
                <div className="w-12 h-12 rounded-full bg-teal-500/10 border border-teal-500/20 flex items-center justify-center mx-auto mb-4">
                  <span className="text-teal-400 text-sm font-bold">{step}</span>
                </div>
      ...
      <section className="px-6 lg:px-16 py-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <button
            ...
            className="px-8 py-4 bg-teal-500 text-stone-900 rounded-2xl text-sm font-bold hover:bg-teal-400 transition-all inline-flex items-center gap-2"
          >
      ...
      <footer className="border-t border-white/5 px-6 lg:px-16 py-8">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <p className="text-stone-600 text-xs">MTSS Wellbeing Platform for Australian Schools</p>
        </div>
      </footer>
      ...
      {showFinder && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={() => { setShowFinder(false); setResult(null); setSlug(''); }}>
          <div
            className="bg-stone-900 border border-stone-700 rounded-3xl shadow-2xl w-full max-w-md p-8 relative"
          ...
          >
            ...
            <p className="text-stone-400 text-sm mb-6">Enter your school's tag to access your portal.</p>
            ...
            <div className="relative mb-4">
              <input
                ...
                className="w-full bg-stone-800 border border-stone-600 rounded-xl px-4 py-3.5 text-sm text-white placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500"
              />
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-stone-600 text-xs font-mono">.{BASE_DOMAIN}</span>
            </div>

            {result && result.exists && (
              <div className="flex items-center gap-2 bg-teal-500/10 border border-teal-500/20 rounded-xl p-3 mb-4 text-teal-400 text-sm" data-testid="school-found-msg">
                <CheckCircle size={16} />
            ...
            <button
              ...
              className="w-full bg-teal-500 text-stone-900 py-3.5 rounded-xl text-sm font-bold hover:bg-teal-400 disabled:opacity-40 transition-all flex items-center justify-center gap-2"
            >
            ...
            <p className="text-center text-stone-600 text-xs mt-4">
              Your school URL will be <strong className="text-stone-400">{slug || 'yourschool'}.{BASE_DOMAIN}</strong>
            </p>
          </div>
        </div>
      )}
