      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        {loading ? (
          <>
            ...
            <div className="hidden sm:block p-8 space-y-3">
          ...
          students.length === 0 ? (
            <EmptyState
              ...
              onSecondaryAction={() => setShowAddStudent(true)}
            />
          ) : (
            <EmptyState
              type="students_filtered"
              onAction={() => { setSearch(''); setFilterClass(''); setFilterTier(''); setFilterChronicOnly(false); }}
            />
          )
        ) : (
          <>
